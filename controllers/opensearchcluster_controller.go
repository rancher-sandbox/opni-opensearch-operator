...
//+kubebuilder:rbac:groups=opensearch.opni.io.my.domain,resources=opensearchclusters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=opensearch.opni.io.my.domain,resources=opensearchclusters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=opensearch.opni.io.my.domain,resources=opensearchclusters/finalizers,verbs=update
...
func (r *OpensearchClusterReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&opensearchopniiov1beta1.OpensearchCluster{}).
		Complete(r)
}
